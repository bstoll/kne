...
[AlpineVS](https://github.com/sonic-net/sonic-alpine/blob/master/README.md) (AVS)
is a SONiC Virtual Switch with dataplane deployed as a k8s Pod within KNE. It
provides switch capabilities in a simulated environment with following key
features:
...
- **Dual-Container Architecture:** Encloses a SwitchStack container (running
  ...
  [alpine](../topo/node/alpine/alpine.go).
